...
const MENU_ITEMS: MenuItemType[] = OBJECT_TYPES
  .filter(t => t.label)
  .map((t: ObjectType): MenuItemType => ({key: t.key, label: t.label, icon: t.icon}));
...
const App = React.memo(() => {
  ...
  const updateObjects = useCallback((isInitial: boolean) => {
