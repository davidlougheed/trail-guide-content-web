...
export const API_BASE_URL = GLOBAL_TGCW_CONFIG?.API_BASE_URL || process.env.TGCW_API_BASE_URL;
export const APP_BASE_URL = GLOBAL_TGCW_CONFIG?.APP_BASE_URL || process.env.TGCW_APP_BASE_URL;
